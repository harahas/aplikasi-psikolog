                    ...
                    <div class="header-top-cta d-flex align-items-center">
                        <div class="cta-info-item position-relative d-flex align-items-center">
                            ...
                            <div class="inner-text headline">
                                <h4>Alamat</h4>
                                <span>Villa Garden, Jl. Skp, Lengkongsari, Kec. Tawang, Tasikmalaya</span>
                            </div>
                        </div>
                        <div class="cta-info-item position-relative d-flex align-items-center">
                            <div class="inner-icon">
                            ...
                            <div class="inner-text headline">
                                <h4>Email us</h4>
                                <span>akhlaqul.karimah@gmail.com</span>
                            </div>
                        </div>
                        <div class="cta-info-item position-relative d-flex align-items-center">
                            <div class="inner-icon">
                    ...
                    <nav class="in-main-navigation-area clearfix ul-li">
                        <ul id="main-nav" class="nav navbar-nav clearfix">
                            <li class="dropdown in-megamenu">
                                <a href="/">Beranda</a>
                            <li class="dropdown">
                                <a class="" href="#">Layanan</a>
                                <ul class="dropdown-menu clearfix">
                                    <li><a target="_blank" href="/akhlaqul-karimah">Parenting </a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Seminar</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Training</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Konseling</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Psikoterapi</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Psikoedukasi</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Psikotest</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Asesmen Lengkap</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Coaching</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Fokus Grup Discussion</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Terapi ABK</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Home Schooling</a></li>
                                    <li><a target="_blank" href="/bukit-bintang">Outbond</a></li>
                                </ul>
                            </li>
                            <li><a target="_blank" href="about.html">Kerja Sama</a></li>
                            </li>
                            <li><a target="_blank" href="about.html">Testimoni</a></li>
                            </li>
                            <li><a target="_blank" href="about.html">Tentang Kami</a></li>
                            </li>
