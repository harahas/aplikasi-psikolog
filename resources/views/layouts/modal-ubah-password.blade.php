                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" style="border: 1px solid rgb(180, 180, 180); cursor:pointer" id="eye"><i class=" ri-eye-line"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" style="border: 1px solid rgb(181, 181, 181); cursor:pointer" id="eye2"><i class=" ri-eye-line"></i></span>
                                    </div>
                                </div>
                            </div>
                        </form>
